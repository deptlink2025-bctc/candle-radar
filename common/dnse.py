"""Giá cổ phiếu từ DNSE/Entrade — miễn phí, không token. Chép nguyên từ tudoanh-radar/common/dnse.py
(bản đó chép từ KingStock), chỉ đổi PRICE_UNIT: app này giữ giá theo NGHÌN ĐỒNG như bảng giá
CTCK và như KingStock — mẫu hình nến chỉ dùng tỷ lệ nên đơn vị không ảnh hưởng gì.
...
HISTORY_DAYS = 260
# DNSE trả giá theo NGHÌN đồng (HPG = 23.3 nghĩa là 23.300 đ). App này GIỮ NGUYÊN đơn vị đó
# (tudoanh-radar nhân 1000 vì cần VND để định giá danh mục; ở đây chỉ hiển thị giá như bảng giá).
PRICE_UNIT = 1.0
