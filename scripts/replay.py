"""Tua lịch sử: mỗi mẫu xuất hiện bao nhiêu lần, và sau đó giá đi đâu — CHẠY TRƯỚC KHI BẬT PUSH.
    ...
    venv\\Scripts\\python -m scripts.replay                       # 39 mã từ KingStock, 750 ngày
...
Cách đọc (bài học KingStock 11/09/2026 — bộ lọc ADX/MA đã bị gỡ vì con số không tái lập được):
...
def main() -> int:
    ...
    p.add_argument("--symbols", default="", help="Danh sách mã, cách nhau bởi dấu phẩy (mặc định: KingStock)")
